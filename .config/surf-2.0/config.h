...
#define SETPROP(p, q) { \
        .v = (const char *[]){ "/bin/sh", "-c", \
             "prop=\"`xprop -id $2 $0 " \
             "| sed \"s/^$0(STRING) = \\(\\\\\"\\?\\)\\(.*\\)\\1$/\\2/\" " \
             "| xargs -0 printf %b | dmenu -l 15 -x 500 -y 200 -w 380 -fn \"JetBrainsMono Nerd Font:style=Regular:size=10\" -nb \"#282828\" -nf \"#ebdbb2\" -sb \"#fb6150\" -sf \"#1d2021\" -bw 2`\" &&" \
...
static SiteStyle styles[] = {
	...
	// { ".*www.google.com.*",     "gruvbox-google.com.css" },
	// { ".*www.duckduckgo.com.*", "gruvbox-duckduckgo.com.css" },
    // { ".*www.wikipedia.org.*",  "gruvbox-mediawiki.org.css" },
    // { ".*www.github.com.*",     "gruvbox-github.css" },
    // { ".*www.stackexchange.com.*",     "gruvbox-stackexchange.com.css" },
    // { ".*www.reddit.com.*",     "gruvbox-reddit.com.css" },
...
#define HOMEPAGE "/home/fmash/github/dotfiles/firefox_css/homepage/index.html"
